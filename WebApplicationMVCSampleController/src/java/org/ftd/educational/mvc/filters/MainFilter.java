 ...
 */
package org.ftd.educational.mvc.filters;
 ...
 * @author Cyber
 */
@WebFilter(filterName = "MainFilter", urlPatterns = {"/WEB-INF/**", "/mvc"})
public class MainFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (isUserAuthorized) {
            if (DEBUG) {
                System.out.println("MainFilter: Sessão válida!");
            }
            chain.doFilter(request, response);
        } else {
            if (DEBUG) {
                System.out.println("MainFilter: Sessão inválida!");
            }
            request.setAttribute("msg", "Sua sessão de trabalho não é válida ou expirou!");
